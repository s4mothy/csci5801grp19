...
public class FillBlankProblem extends AbstractProblem {
    ...
    /**
     * @brief default Constructor (doesn't specify parameters; type = 0, debug =
     *        false)
     * @param myFile is the opened source code file
     * 
     * @return instance of this class
    ...
    public FillBlankProblem(File myFile) {
        ...
        this.makeProblem(myFile, type, false);
    }
    ...
    /**
     * @brief This is the main workhorse of this class. Populates the class
     *        variables
     *        with a proper, finished problem bassed on the specifications.
     * @param myFile the opened source code file.
     * @param type   determines which type of keyword or operator to replace with a
     *               blank.
     *               0 for keyword, 1 for arithmetic operator, 2 for assignment
     *               operator, 3 for
